...
def distance_dots():
    ...
    first_coordinate_x = float(prompt.user_say())
    prompt.bot_say("Введіть координату Y першої точки")
    first_coordinate_y = float(prompt.user_say())
    prompt.bot_say("Введіть координату X другої точки")
    second_coordinate_x = float(prompt.user_say())
    prompt.bot_say("Введіть координату Y другої точки")
    second_coordinate_y = float(prompt.user_say())
